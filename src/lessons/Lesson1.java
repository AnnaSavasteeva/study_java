...
//        Конкатенация строк
//        Опасная операция, может дать сильную просадку по производительности (не только в Java):
//        - str - одна строка
//        - в процессе конкатенации n неявно преобразуется во вторую строку и хранится в памяти
//        - выражение str + n дает третью временную строку, хранящуюся в памяти
